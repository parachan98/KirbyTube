...
// we are logged in... first things first, are we friends?
...
$stmt = $conn->prepare('SELECT * FROM videos WHERE uploaded_by=:t0 AND isPrivate=1 ORDER BY uploaded_on DESC LIMIT :t1, :t2');
$stmt->bindParam(":t0", $_GET["user"]);
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
	<tr valign="top">
			...
			<tr>
				...
				<div class="watchTitleBar">
					<table width="100%" cellpadding="0" cellspacing="0" border="0">
						<tr valign="top">
							<td><div class="watchTitle">Private Videos // <span style="text-transform: capitalize;"><?php echo $_GET["user"]; ?></span></div></td>
 							<td align="right"> 
								<div style="font-weight: bold; color: #444; margin-right: 5px;">
								<?php echo "Videos " . $page . "-" . $stmt->rowCount() + $page - 1 . " of " . $private_videos;?>
								</div>
							</td>
						</tr>
					</table>
		...
		<div style="font-size: 14px; font-weight: bold; margin-bottom: 10px; color: #444;">&#187; Private Videos</div>
